...
const AreaContainer = () => {
  return (
    <a className="[text-decoration:none] self-stretch flex-1 flex flex-col py-[53px] px-[50px] items-center justify-start gap-[45px] text-center text-21xl text-primary-800 font-body-regular-600">
